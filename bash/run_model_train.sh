...
CUDA_VISIBLE_DEVICES=0 chrombpnet pipeline \
  ...
  -b /oak/stanford/groups/akundaje/abuen/personal_genome/chrombpnet/bias_train_output/models/bias.h5 \
  -o /oak/stanford/groups/akundaje/abuen/personal_genome/chrombpnet/pipeline_train_output
